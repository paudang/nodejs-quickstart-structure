    ...
    const questions = [
        ...
        },
        {
            ...
            when: (answers) => {
                ...
                return (advanced === 'Yes' || advanced === true) && comm !== 'Kafka' && options.useApiGateway === undefined && options.apiGateway === undefined;
            }
        },
        {
            type: 'select',
            ...
            default: 'Nginx',
            when: (answers) => {
                const useGw = options.useApiGateway !== undefined ? options.useApiGateway : answers.useApiGateway;
                return (useGw === 'Yes' || useGw === true) && options.apiGateway === undefined;
            }
        },
        {
            type: 'checkbox',
