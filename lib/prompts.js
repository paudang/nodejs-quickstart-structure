...
export const getProjectDetails = async (options = {}) => {
    ...
    } else if (typeof result.withELK === 'string') {
        result.withELK = result.withELK === 'Yes';
    ...
    } else if (typeof result.backgroundJobs === 'string') {
        result.backgroundJobs = result.backgroundJobs === 'Yes';
